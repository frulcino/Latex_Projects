...
\begin{frame}{The Problem}
    % \begin{itemize}
    %     \item Rising global temperatures
    %     \item Extreme weather events
    %     \item Need for decarbonization
    % \end{itemize}
    %\uncover
    %\includegraphics[width=0.8\textwidth]{ipcc_report_image.png} % Replace with real image from IPCC
\end{frame}
...
\begin{frame}{Nuclear?}
    %\includegraphics[width=0.5\textwidth]{nuclear_joke.png} % Replace with a joke about nuclear energy
    \begin{itemize}
        \item Too expensive?
